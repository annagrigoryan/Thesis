...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3' => 'get126e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3Service',
            '2_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3' => 'get226e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3Service',
        ...
        $this->privates = array(
            '1_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3' => true,
            '2_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3' => true,
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'IsmaAmbrosiGeneratorBundle', ($this->targetDirs[3].'/app/Resources/IsmaAmbrosiGeneratorBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'IsmaAmbrosiGeneratorBundle', ($this->targetDirs[3].'/vendor/ismaambrosi/generator-bundle/IsmaAmbrosi/Bundle/GeneratorBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3']) ? $this->services['1_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3'] : $this->get126e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3']) ? $this->services['2_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3'] : $this->get226e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $a->setNamespace('sf_mongodb_default_3eec8b58597ac5b503443e2bc0c49dd13f18bc998419d539165f46f6cd726249');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->get('twig.loader')) && false ?: '_'}, array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => NULL), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, ${($_ = isset($this->services['templating.name_parser']) ? $this->services['templating.name_parser'] : $this->get('templating.name_parser')) && false ?: '_'}, true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'DoctrineMongoDBBundle', 9 => 'KnpPaginatorBundle', 10 => 'DSSBundle', 11 => 'StofDoctrineExtensionsBundle', 12 => 'LiipImagineBundle', 13 => 'IvoryCKEditorBundle', 14 => 'DebugBundle', 15 => 'WebProfilerBundle', 16 => 'SensioDistributionBundle', 17 => 'SensioGeneratorBundle', 18 => 'IsmaAmbrosiGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    /**
     * Gets the private '1_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get126e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3Service()
    {
        return $this->services['1_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get226e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3Service()
    {
        return $this->services['2_26e27414ebb617e79096437f13df18a9034f677b9b42920b9db01abd641acff3'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('m8LzkGdn1g', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6h5KaKqIIG', 0, 'Ot-8KAy-J7A3VgmNP5xI+A', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CizDijeIfx', 0, 'Ot-8KAy-J7A3VgmNP5xI+A', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9Ayet59otU', 0, 'Ot-8KAy-J7A3VgmNP5xI+A', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5abcd83961d8b1.07444615');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'IsmaAmbrosiGeneratorBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/ismaambrosi/generator-bundle/IsmaAmbrosi/Bundle/GeneratorBundle'),
